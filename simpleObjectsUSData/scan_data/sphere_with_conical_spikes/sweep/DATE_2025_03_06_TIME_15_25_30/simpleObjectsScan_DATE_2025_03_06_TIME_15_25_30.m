...
data_path = 'C:\Users\PratikDash\Documents\UltrasoundSimulation\B-mode_simple_objects\tmp\sphere_with_conical_spikes\sweep\DATE_2025_03_06_TIME_15_25_30\';

% set the location to save intermediate I/O files
io_path = '<ENTER_LOCATION_WHERE_INTERMEDIATE_IO_FILES_WILL_BE_SAVED>\';

% set the name of the intermediate input and output data files
data_name = '<ENTER_NAME_OF_THE_INTERMEDIATE_DATA_FILES>';

% set the location of the .mat file which will contain properties
% of the medium
mat_file = 'C:\Users\PratikDash\Documents\UltrasoundSimulation\B-mode_simple_objects\images\sphere_with_conical_spikes.mat';
...
medium_y_starting_position = <ENTER_MEDIUM_Y_STARTING_INDEX>; % in [grid points]

% set the number of scan lines
number_scan_lines = <ENTER_NUMBER_OF_SCAN_LINES>;
